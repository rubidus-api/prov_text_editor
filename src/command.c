        ...
        switch (p->ns) {
            ...
            case 'z':
                switch (key) {
                    ...
                    case 'y': return action_cmd(p, PROV_ACT_REDO);
    ...
    switch (p->state) {
        ...
        case PS_NAMESPACE:
            switch (p->ns) {
                ...
                case 'z': put(buf, n, "meta: x:exit w:write q:quit y:redo o:open h:help"); return;
    ...
    switch (c->kind) {
        ...
        case PROV_CMD_ACTION:
            switch (c->action) {
                ...
                case PROV_ACT_REDO:           put(buf, n, "redo");       return;
