...
/* Monotonic edit counter: changes whenever buffer content changes (insert/delete,
 * including undo/redo). A cache key for incremental syntax highlighting (RFC-0022);
